  ...
  interface FormulaExtractorEnvironment {
  ...
  function createEnvironment(overrides: FormulaExtractorEnvironment = {}): Required<FormulaExtractorEnvironment> {
    return {
      documentRef: overrides.documentRef || document
    };
  }

  function createFormulaExtractorApi(environment: FormulaExtractorEnvironment = createEnvironment()) {
